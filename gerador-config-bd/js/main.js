class Main {
    ...
    static onClickBaixar() {
        const conteudo = "data:text/json;charset=utf-8," + encodeURIComponent(JSON.stringify(this.getObjetoDados()), null, 4);
        var link = document.createElement('a');
        link.setAttribute("href", conteudo);
        link.setAttribute("download", `data-base-config.json`);
